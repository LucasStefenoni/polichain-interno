...
export const Item = (props: itemProps) => {
  return (
    <div className="max-w-sm bg-white border border-black rounded-lg">
        <a href={"/venda/" + props.nome + "/" + props.valor + props.imagem}>
        ...
        <div className="p-5">
            ...
            <a href={"/venda/" + props.nome + "/" + props.valor + props.imagem} className="text-white bg-black  hover:bg-gray-400 hover:ring-gray-400 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2 text-center">
                Comprar
            </a>
        </div>
    </div>
